      ...
      <Card padding="lg">
        <div className="text-center py-10">
          ...
          <p className="font-body text-sm text-muted-fg mb-4">
            Please sign in again to load staff applications.
          </p>
          <Button
            variant="outline"
            size="sm"
        ...
        <div>
          ...
          <p className="font-body text-muted-fg text-sm mt-0.5">
            ...
            {`application${total !== 1 ? "s" : ""} ${
              assignedSchool ? `for ${assignedSchool}` : "across all schools"
            }`}
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Search applicant name or student number..."
