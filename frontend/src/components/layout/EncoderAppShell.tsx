...
import { Users, Sun, Moon, Menu, X, LogOut } from "lucide-react";

const encoderNavItems = [
  { href: "/encoder/students", label: "Students", icon: Users },
];

function EncoderSidebar({
  open,
  onClose,
}: {
  open: boolean;
  ...
  return (
    <>
      ...
      <aside
        ...
        `}
        aria-label="Encoder navigation"
      >
        <div className="p-6 flex items-center justify-between">
          <Link
            href="/encoder/students"
...
function EncoderHeader({ onMenuToggle }: { onMenuToggle: () => void }) {
  return (
...
export function EncoderAppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <EncoderHeader onMenuToggle={() => setSidebarOpen(true)} />
